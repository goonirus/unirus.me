...
服务器启动后，在浏览器访问：**http://localhost:8000/public/index.html**
...
1. 安装 “Live Server” 扩展
2. 在 VS Code 中右键 `public/index.html`
3. 选择 “Open with Live Server”

## 方法 5：直接打开（不推荐）

可以运行 `scripts/quick-preview.bat` 或直接双击 `public/index.html`，但由于依赖 CDN，建议还是通过本地服务器运行。
